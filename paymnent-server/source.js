...
const init = async () => {
    ...
    const apiKey = '9df9f664f1b463e3c905be6a1d64c27eda8aae50c6d4e1f31f8717ed1bf3e3ce'; // Obtain your API key in https://t.me/tontestnetapibot
    ...
    const seedA = TonWeb.utils.base64ToBytes('YWJvYnVzYWpzZGFpa2RucWlkc25hbHdkaWFqd29kYXc='); // A's private (secret) key
    const keyPairA = tonweb.utils.keyPairFromSeed(seedA); // Obtain key pair (public key and private key)
    
    const seedB = TonWeb.utils.base64ToBytes('YmJvYnVzYWpzZGFpa2RucWlkc25hbHdkaWFqd29kYXc='); // B's private (secret) key
    ...
    let balanceATon = await tonweb.getBalance(walletAddressA)
    console.log('balanceA in ton = ', balanceATon)
    ...
    let balanceBTon = await tonweb.getBalance(walletAddressB)
    console.log('balanceB in ton = ', balanceBTon)
    ...
    const channelInitState = {
        ...
        balanceB: toNano('0.02'), // B's initial balance in Toncoins. Next B will need to make a top-up for this amount
        seqnoA: new BN(0), // initially 0
        seqnoB: new BN(0)  // initially 0
    };
    //let channelId = Math.floor(Math.random() * 10000000)
    let channelId = 6034068
    console.log('channel state', channelId)
    const channelConfig = {
    ...
    let kek = await fromWalletA.deploy().send(toNano('0.05'));
    console.log("kek:", kek);
